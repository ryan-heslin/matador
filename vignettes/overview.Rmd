...
m <- matrix(c(cos(pi/3), sin(pi/3), -sin(pi/3), cos(pi/3)), nrow =2)
mat_pows(m, 1:7)
```
...
I hope matador will help you spend less time poring over matrices and more appreciating their elegance.
